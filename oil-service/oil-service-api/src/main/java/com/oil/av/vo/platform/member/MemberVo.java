package com.oil.av.vo.platform.member;
 ...
 *   <tr><td>memberSexEnum</td><td>{@link java.lang.String}</td><td>sex</td><td>varchar</td><td>性别:enum:man,男;women,女;none,未设置;</td></tr>
 ...
 *   <tr><td>lastSerialNumber</td><td>{@link java.lang.String}</td><td>last_serial_number</td><td>varchar</td><td>最后序列号</td></tr>
 ...
 *   <tr><td>memberPublicMessageEnum</td><td>{@link java.lang.String}</td><td>public_message</td><td>varchar</td><td>公告接收状态  enum:open,开启;close,结束;</td></tr>
 * </table>
 */
public class MemberVo extends BaseVo{
	     ...
	     */
 		...
 		private MemberSexEnum memberSexEnum;
 		/**
	     * 获取性别:enum:man,男;women,女;none,未设置;
	     */
 		public MemberSexEnum getMemberSexEnum(){
 			return this.memberSexEnum;
 		}
 		
 		/**
	     * 设置性别:enum:man,男;women,女;none,未设置;
	     */
 		public void setMemberSexEnum(MemberSexEnum memberSexEnum){
 			this.memberSexEnum= memberSexEnum;
 		} 		
	     ...
	     */
 		public MemberStateEnum getMemberStateEnum(){
 			return this.memberStateEnum;
 		}
 		
 		/**
	     * 设置账号状态:enum:normal,正常;lock,锁定;destroy,注销;seal,封号;safety,安全问题;
	     */
 		public void setMemberStateEnum(MemberStateEnum memberStateEnum){
 			this.memberStateEnum= memberStateEnum;
 		} 		
	     ...
	     */
 		...
 		private java.lang.String lastSerialNumber;
 		/**
	     * 获取最后序列号
	     */
 		public java.lang.String getLastSerialNumber(){
	     ...
	     * 设置最后序列号
	     */
 		public void setLastSerialNumber(java.lang.String lastSerialNumber){
	     ...
	     */
 		...
 		private MemberPublicMessageEnum memberPublicMessageEnum;
 		/**
	     * 获取公告接收状态  enum:open,开启;close,结束;
	     */
 		public MemberPublicMessageEnum getMemberPublicMessageEnum(){
 			return this.memberPublicMessageEnum;
 		}
 		
 		/**
	     * 设置公告接收状态  enum:open,开启;close,结束;
	     */
 		public void setMemberPublicMessageEnum(MemberPublicMessageEnum memberPublicMessageEnum){
 			this.memberPublicMessageEnum= memberPublicMessageEnum;
 		} 		

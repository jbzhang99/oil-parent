...
/**
 * 运营管理-短信模板
 * <p>Table: <strong>po_sm_template</strong>
 * <p><table class="er-mapping" cellspacing=0 cellpadding=0 style="border:solid 1 #666;padding:3px;">
 *   <tr style="background-color:#ddd;Text-align:Left;">
 *     <th nowrap>属性名</th><th nowrap>属性类型</th><th nowrap>字段名</th><th nowrap>字段类型</th><th nowrap>说明</th>
 *   </tr>
 *   <tr><td>id</td><td>{@link java.lang.String}</td><td>id</td><td>varchar</td><td>主键</td></tr>
 *   <tr><td>smTemplateNameEnum</td><td>{@link java.lang.String}</td><td>name</td><td>varchar</td><td>模板名称:enum:register,注册验证码;pwdmodify,密码修改;notice,通知;active,活动;</td></tr>
...
public class SmsTemplateVo extends BaseVo{
	     ...
	     */
 		...
 		private SmsTemplateNameEnum smTemplateNameEnum;
 		/**
	     * 获取模板名称:enum:register,注册验证码;pwdmodify,密码修改;notice,通知;active,活动;
	     */
 		public SmsTemplateNameEnum getSmTemplateNameEnum(){
 			return this.smTemplateNameEnum;
 		}
 		
 		/**
	     * 设置模板名称:enum:register,注册验证码;pwdmodify,密码修改;notice,通知;active,活动;
	     */
 		public void setSmTemplateNameEnum(SmsTemplateNameEnum smTemplateNameEnum){
 			this.smTemplateNameEnum= smTemplateNameEnum;
 		} 		
